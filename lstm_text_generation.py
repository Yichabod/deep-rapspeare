...
try:
    ...
    in_text = open('/home/ubuntu/torch-rnn/RapSpeare.txt', 'r').read()
...
def main(num_epochs=NUM_EPOCHS):
    ...
    #save_weights(l_out)
    load_weights(l_out)
    #load weights from pretrain weight file "layers.npz"
    ...
    def try_it_out(N=1000, generation_phrase = generation_phrase):
        '''
